...
<a href="logout.php" class="text-success text-right">
    ...
    <div class="qr-detected-container" id="detected-container" style="display: none;">
        <form id="auto-submit-form" method="POST" action="emailsentQR.php">
    ...
    <div class="manual-input-container" id="manual-container" style="display: none;">
        ...
        <form method="POST" action="emailsentQR.php">
